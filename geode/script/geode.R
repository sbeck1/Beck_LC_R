...
g=read.csv("geode/data/development/geode_points.csv")
...
write.csv(g2, "geode/data/development/geode_points_sep.csv")
...
g_t_length=read.csv("geode/data/development/geode_point_lines_exp.csv")

#calculated distance from USGS Wilcox gauge to transect start points
g_t_usgs=read.csv("geode/data/development/geode_point_trans_dist_usgs_exp.csv")

#calculated transect distances from eachother 
g_t_dist=read.csv("geode/data/development/geode_point_trans_dist_exp.csv")
...
write.csv(g_t_spatial, "geode/data/development/g_t_spatial.csv")
...
write.csv(g_t_dist, "geode/data/development/g_t_dist.csv")
