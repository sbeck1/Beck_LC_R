...
hist(shell_bag2$snail_cnt)  #look for outliers, set range below which will create datasets that contain extreme values
snail_check1=shell_bag2[which(shell_bag2$snail_cnt>10),]
